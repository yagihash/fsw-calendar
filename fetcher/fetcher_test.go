...
func TestFetcher_FetchDocEvents(t *testing.T) {
	...
	t.Run("error http not found", func(t *testing.T) {
		...
		f := New("example.com", course.RC, class.T4, c)
		_, err := f.FetchDocEvents(2023, 11)
