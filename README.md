...
A small TypeScript implementation that automatically registers the schedules of the membership driving slots at Fuji International Speedway into Google Calendar.
